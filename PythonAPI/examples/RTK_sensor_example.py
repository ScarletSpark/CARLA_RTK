...
class World(object):
    def __init__(self, carla_world, hud, args):
        ...
        self.rtk_compass = None
        self.rtk_sensor = None
        self.rtk_sensor_base = None
    ...
    def destroy(self):
        ...
        sensors = [
            ...
            self.rtk_compass.sensor,
            self.rtk_sensor.sensor,
            self.rtk_sensor_base.sensor,
...
class GnssSensor(object):
    def __init__(self, parent_actor, x_val, y_val, z_val, noise, rover):
        ...
        bp.set_attribute("noise_seed",str(17))
        if rover :
...
class RtkSensor(object):
    def __init__(self, parent_actor, x_val, y_val, z_val, noise, rover):
        ...
        self.y_coord = y_val
        world = self._parent.get_world()
        bp = world.get_blueprint_library().find('sensor.other.rtk')
        bp.set_attribute("geo_flag","false")
        # if rover :
        #     bp.set_attribute("noise_lat_bias",str(0.0))
        #     bp.set_attribute("noise_lat_stddev",str(0.0022)) # ~0.00000009
        ...
        #     bp.set_attribute("noise_lon_stddev",str(0.0022))
        bp.set_attribute("noise_lat_bias",str(0.0))
        bp.set_attribute("noise_lat_stddev",str(noise)) # ~0.00000009 # 0.0022
        bp.set_attribute("noise_lon_bias",str(0.0))
        bp.set_attribute("noise_lon_stddev",str(noise))
        bp.set_attribute("noise_seed",str(17))
        if rover :
        ...
        # reference.
        weak_self = weakref.ref(self)
        self.sensor.listen(lambda event: RtkSensor._on_rtk_event(weak_self, event))

    @staticmethod
    def _on_rtk_event(weak_self, event):
        self = weak_self()
        if not self:
            return
        self.lat = event.latitude
...
class RtkCompass(object):
    def __init__(self, parent_actor, weak_gnss_1, weak_gnss_2):
        ...
        # reference.
        weak_self = weakref.ref(self)
        self.sensor.listen(lambda event: RtkCompass._on_rtk_event(weak_self))
